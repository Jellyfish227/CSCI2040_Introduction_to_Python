...
if os.path.isfile('p3.py'):
    ...
    try:
        ...
        expected = {'Space Engineering': ['Mark', 'Neo', 'Jane'], 'Computer Science': ['John', 'James', 'Andrew', 'Michael', 'Leo', 'Kevin', 'Jack', 'Clare', 'Daisy', 'Alice'], 'Math': ['Ann', 'Andrew', 'David', 'George'], 'Economics': ['Andrew', 'David', 'Jason', 'Julian']}
    ...
    try:
        ...
        expected = {'Economics': 4, 'Computer Science': 10, 'Math': 4, 'Space Engineering': 3}
        try:
            print('Testing...')
